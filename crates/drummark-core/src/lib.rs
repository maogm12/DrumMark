...
fn normalize_to_js(score: &normalize::NormalizedScore) -> JsValue {
    ...
    // Header
    let h = Object::new();
    if let Some(ref t) = score.header.title {
        set(&h, "title", &JsValue::from_str(t));
    }
    if let Some(ref t) = score.header.subtitle {
        set(&h, "subtitle", &JsValue::from_str(t));
    }
    if let Some(ref t) = score.header.composer {
        set(&h, "composer", &JsValue::from_str(t));
    }
    ...
    set(
        &ts,
        "beats",
        &JsValue::from_f64(score.header.time_beats as f64),
    );
    set(
        &ts,
        "beatUnit",
        &JsValue::from_f64(score.header.time_beat_unit as f64),
    );
    set(&h, "timeSignature", &ts.into());
    set(
        &h,
        "divisions",
        &JsValue::from_f64(score.header.divisions as f64),
    );
    set(
        &h,
        "noteValue",
        &JsValue::from_f64(score.header.note_value as f64),
    );
    let ga = Array::new();
    for &g in &score.header.grouping {
        ga.push(&JsValue::from_f64(g as f64));
    }
    ...
    for m in &score.measures {
        ...
        set(
            &mo,
            "globalIndex",
            &JsValue::from_f64(m.global_index as f64),
        );
        set(
            &mo,
            "paragraphIndex",
            &JsValue::from_f64(m.paragraph_index as f64),
        );
        set(
            &mo,
            "measureInParagraph",
        ...
        if let Some(ref b) = m.closing_barline {
            set(&mo, "closingBarline", &JsValue::from_str(b));
        }
        ...
        if let Some(ref v) = m.volta {
            let va = Array::new();
            for n in v {
                va.push(&JsValue::from_f64(*n as f64));
            }
        ...
        if let Some(slashes) = m.measure_repeat_slashes {
            set(
                ...
                &JsValue::from_f64(slashes as f64),
            );
        }
        ...
        if !m.hairpins.is_empty() {
            ...
            for hp in &m.hairpins {
                ...
                set(
                    &ho,
                    "kind",
                    &JsValue::from_str(match hp.kind {
                ...
                set(
                    &ho,
                    "startMeasureIndex",
                    &JsValue::from_f64(hp.start_measure_index as f64),
                );
                set(&ho, "end", &frac_js(hp.end));
                set(
                    &ho,
                    "endMeasureIndex",
                    &JsValue::from_f64(hp.end_measure_index as f64),
                );
                ha.push(&ho.into());
            }
        ...
        for ev in &m.events {
            ...
            set(
                &evo,
                "kind",
                &JsValue::from_str(match ev.kind {
            ...
            if !ev.modifiers.is_empty() {
                ...
                for m in &ev.modifiers {
                    ma_mod.push(&JsValue::from_str(m));
                }
...
fn frac_js(f: crate::fraction::Fraction) -> JsValue {
    ...
    set(
        &obj,
        "denominator",
        &JsValue::from_f64(f.denominator as f64),
    );
    obj.into()
}
...
fn render_score_to_js(score: &drummark_layout::RenderScore) -> JsValue {
    ...
    set(
        &header,
        "tempo",
        &JsValue::from_f64(score.header.tempo as f64),
    );
    set(
        &header,
        "timeBeats",
    ...
    if let Some(ref title) = score.header.title {
        set(&header, "title", &JsValue::from_str(title));
    }
    if let Some(ref subtitle) = score.header.subtitle {
        set(&header, "subtitle", &JsValue::from_str(subtitle));
    }
    if let Some(ref composer) = score.header.composer {
        set(&header, "composer", &JsValue::from_str(composer));
    }
    ...
    for measure in &score.measures {
        ...
        set(
            &entry,
            "paragraphIndex",
            &JsValue::from_f64(measure.paragraph_index as f64),
        );
        set(
            &entry,
            "measureInParagraph",
            &JsValue::from_f64(measure.measure_in_paragraph as f64),
        );
        set(
            &entry,
            "sourceLine",
            &JsValue::from_f64(measure.source_line as f64),
        );
        set(
            &entry,
            "noteValue",
            &JsValue::from_f64(measure.note_value as f64),
        );
        set(
            &entry,
            "voltaTerminator",
            &JsValue::from_bool(measure.volta_terminator),
        );
        ...
        if let Some(ref closing_barline) = measure.closing_barline {
            set(
                &entry,
                "closingBarline",
                &JsValue::from_str(closing_barline),
            );
        }
        if let Some(ref start_nav) = measure.start_nav {
            set(
                &entry,
                "startNav",
                &JsValue::from_str(match start_nav {
        ...
        if let Some(ref end_nav) = measure.end_nav {
            set(
                &entry,
                "endNav",
                &JsValue::from_str(match end_nav {
        ...
        for hairpin in &measure.hairpins {
            ...
            set(
                &hairpin_obj,
                "kind",
                &JsValue::from_str(match hairpin.kind {
            ...
            set(
                &hairpin_obj,
                "startMeasureIndex",
                &JsValue::from_f64(hairpin.start_measure_index as f64),
            );
            set(
                &hairpin_obj,
                "endMeasureIndex",
                &JsValue::from_f64(hairpin.end_measure_index as f64),
            );
        ...
        for dynamic in &measure.dynamics {
            ...
            set(
                &dynamic_obj,
                "level",
                &JsValue::from_str(dynamic.level.as_str()),
            );
        ...
        for event in &measure.events {
            ...
            set(
                &event_obj,
                "trackFamily",
                &JsValue::from_str(&event.track_family),
            );
    ...
    for repeat in &score.repeat_spans {
        ...
        set(
            &entry,
            "startMeasure",
            &JsValue::from_f64(repeat.start_measure as f64),
        );
        set(
            &entry,
            "endMeasure",
            &JsValue::from_f64(repeat.end_measure as f64),
        );
...
fn parse_layout_options(options: &JsValue) -> drummark_layout::LayoutOptions {
    ...
    assign_any(&mut opts.stem_len_offset_ss, "stemLenOffsetSs");
