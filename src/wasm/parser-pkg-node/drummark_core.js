 ...
 * @returns {any}
 */
function build_music_xml(source, hide_voice2_rests) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.build_music_xml(ptr0, len0, hide_voice2_rests);
    return takeObject(ret);
}
exports.build_music_xml = build_music_xml;
 ...
 * @returns {any}
 */
function build_normalized_score(source) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_export, wasm.__wbindgen_export2);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.build_normalized_score(ptr0, len0);
    return takeObject(ret);
}
exports.build_normalized_score = build_normalized_score;
